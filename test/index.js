...
describe('nycticorax', () => {
  ...
  it('dispatch', () => {
    ...
    expect(() => nycticorax.dispatch({ b: 1 })).toThrowError(new Error('store key: b not exist'))
    expect(() => nycticorax.dispatch({ a: 'a' })).toThrowError(new Error('store type mismatch, key: a'))
